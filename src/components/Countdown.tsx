      ...
      {timeUnits.map((unit, index) => (
        ...
        >
          <div className="relative group">
            ...
            <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-2xl border border-primary/30 bg-card/80 backdrop-blur-sm flex items-center justify-center overflow-hidden hover:border-primary/50 hover:shadow-mint transition-all duration-300">
              <span 
                key={unit.value}
